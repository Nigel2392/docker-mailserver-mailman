...
func main() {
	var (
		...
		MAILMAN_DOVEADM_API_ADDR = GetEnv("MAILMAN_DOVEADM_API_ADDR")
		MAILMAN_DOVEADM_API_KEY  = GetEnv("MAILMAN_DOVEADM_API_KEY")
	...
	var app = django.App(
		django.AppSettings(django.Config(map[string]interface{}{
			...
			mailmgmt.MAILMAN_DOVEADM_API_ADDR:         MAILMAN_DOVEADM_API_ADDR,
			mailmgmt.MAILMAN_DOVEADM_API_KEY:          MAILMAN_DOVEADM_API_KEY,
