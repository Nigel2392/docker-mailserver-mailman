...
class Modal {
    ...
    declare private elements: Elements;
    declare private documentClickListener: (event: MouseEvent) => void;
    ...
    connect(root: ModalElement) {
        ...
        const actions = this.actions();
        const actors = this.elements.controls?.querySelectorAll("[data-action]") as NodeListOf<HTMLElement>;
    ...
    disconnect() {
        this.elements.root.modal = undefined;
